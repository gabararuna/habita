    ...
    <div className="min-h-screen bg-black text-white relative overflow-hidden font-sans">
      ...
      <div className="max-w-[1200px] mx-auto w-full relative z-10 px-4 pt-12 pb-32">
        <header className="text-center mb-12 relative z-20">
          <div className="inline-block mb-6 px-4 py-1 rounded-full border border-white/10 bg-white/5 backdrop-blur-md text-[#00bfa5] text-[10px] sm:text-xs font-semibold tracking-widest uppercase">
